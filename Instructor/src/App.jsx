...
function App() {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      {/* 2) Sidebar: full width on mobile (top), fixed width on md+ */}
      <aside className="w-full md:w-72 flex-none border-b md:border-r bg-white">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <Routes>
          ...
          {/*temporily added for testing - insert component to the correct position of the dashboard */}
        </Routes>
      </main>
    </div>
  );
